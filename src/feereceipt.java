//This is a Fees Receipt system that i have developed in java swing.
// .It takes some information of student in text fields and then generate receipt
// with unique receipt number and current system date and time
// ..and Receipt can be printed by using any printer and also it can be saved in .xps format..
